...
- [x] Created small gui application using FreeSimpleGUI module, exracted the values from the application window for further processing
- [x] Unittesting with Pytest - used assert to validate the logic, implemented fixtures to set up tests for initialization and reusability
- [x] REST API Integration testing with python and Pytest
